...
export const FooterPagesBlock: FC<FooterPagesProps> = memo(({ page }) => {
  return (
    <li className="flex">
      <Link
        to={page.url}
        className="group/page relative text-[14px] font-bold text-light-turquoise uppercase tracking-[0.48px] cursor-pointer hover:text-cherry transition-colors max-lg:text-center"
      >
        {page.link}
