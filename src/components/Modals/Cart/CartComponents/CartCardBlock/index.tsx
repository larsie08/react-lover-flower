...
export const CartCardBlock: FC<CartCardProps> = memo(
  ({ id, name, cost, imageUrl, quantity, dispatch }) => {
    ...
    return (
      <div className="card_block flex border-b-[1px] border-[#555] py-5 max-lg:py-2">
        {/* Image Block */}
        <div className="img">
        ...
        {/* Info Block */}
        <div className="flex flex-col justify-between lg:ml-5 max-lg:ml-2">
          <h2 className="text-[14px] font-normal tracking-[0.28px] uppercase max-lg:text-[12px] max-lg:tracking-[0.02em]">
            {name}
          </h2>
        ...
        <div className="flex flex-col justify-between ml-auto">
          <p className="text-[14px] text-light-turquoise font-bold tracking-[0.56px] uppercase max-lg:text-[12px] max-lg:tracking-[0.04em]">
            {cost} ₽
          </p>
          <button
