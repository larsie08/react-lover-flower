...
export const QuestionFormBlock: FC = () => {
  ...
  const submit: SubmitHandler<QuestionForm> = (data) => {
    sendAlert();
    console.log(data);
  };
  ...
  return (
    <div className="question_block__form relative flex flex-col z-20 md:items-end mt-8 max-lg:items-center md:mr-[1rem]">
      <form
