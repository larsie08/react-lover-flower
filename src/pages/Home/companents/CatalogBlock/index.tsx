  ...
  return (
    <div className="catalog_block__wrapper h-[1000px]">
      <div className="container relative h-full flex flex-col mx-auto">
        <DecorativeElement className="absolute z-10 top-[34rem] w-[707px] h-[236px] bg-cherry rotate-[32.828deg] rounded-[708px] blur-[125px]" />
        <DecorativeElement className="absolute z-10 top-[24rem] right-[2rem] float-right w-[880px] h-[211px] bg-light-turquoise rotate-[32.828deg] rounded-[880px] blur-[125px]" />
