...
export const BouquetsBlock: FC<BouquetsBlockProps> = memo(({ bouquets }) => {
  return (
    <div className="catalog__content_block h-[280px] lg:mt-36 max-lg:mt-5">
      ...
      <ul className="w-[445px] relative z-20 h-full bg-[#000]/[0.20] backdrop-blur-[10px] rounded-[20px] px-10 py-5 max-sm:w-[300px] max-sm:flex max-sm:flex-col max-sm:items-center max-sm:justify-between md:w-[540px] lg:w-[480px]">
